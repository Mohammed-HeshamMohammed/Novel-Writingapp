  ...
  return (
    <StyledWrapper>
      <div className="notification">
        ...
        <span className="dirt">
          <div className="text">
            <span className="font hover">Level up!</span>
            <span className="font-text hover">Your Words:</span>
            <span className="font-power hover">+8000!</span>
          </div>
